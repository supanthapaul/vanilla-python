...
print("ceil(4.4) = ", math.ceil(4.4))           # ceil rounds up the value
print("floor(4.4) = ", math.floor(4.4))         # Floor rounds down the value
print("fabs(-4.4) = ", math.fabs(-4.4))         # Returns the absolute value
